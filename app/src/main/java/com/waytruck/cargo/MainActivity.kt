...
import com.waytruck.cargo.slider.IndicatorView.draw.controller.DrawController.ClickListener
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.includedLayout.imageSlider.setOnIndicatorClickListener(ClickListener {
            Log.i(
                "GGG",
                "onIndicatorClicked: " + binding.includedLayout.imageSlider.getCurrentPagePosition()
            )
        })
