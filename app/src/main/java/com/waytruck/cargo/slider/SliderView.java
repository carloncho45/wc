package com.waytruck.cargo.slider;

import static com.waytruck.cargo.slider.IndicatorView.draw.controller.AttributeController.getRtlMode;
...
import com.waytruck.cargo.slider.IndicatorView.PageIndicatorView;
import com.waytruck.cargo.slider.IndicatorView.animation.type.BaseAnimation;
import com.waytruck.cargo.slider.IndicatorView.animation.type.ColorAnimation;
import com.waytruck.cargo.slider.IndicatorView.animation.type.IndicatorAnimationType;
import com.waytruck.cargo.slider.IndicatorView.draw.controller.DrawController;
import com.waytruck.cargo.slider.IndicatorView.draw.data.Orientation;
import com.waytruck.cargo.slider.IndicatorView.draw.data.RtlMode;
import com.waytruck.cargo.slider.IndicatorView.utils.DensityUtils;
import com.waytruck.cargo.slider.InfiniteAdapter.InfinitePagerAdapter;
import com.waytruck.cargo.slider.Transformations.AntiClockSpinTransformation;
import com.waytruck.cargo.slider.Transformations.Clock_SpinTransformation;
import com.waytruck.cargo.slider.Transformations.CubeInDepthTransformation;
import com.waytruck.cargo.slider.Transformations.CubeInRotationTransformation;
import com.waytruck.cargo.slider.Transformations.CubeInScalingTransformation;
import com.waytruck.cargo.slider.Transformations.CubeOutDepthTransformation;
import com.waytruck.cargo.slider.Transformations.CubeOutRotationTransformation;
import com.waytruck.cargo.slider.Transformations.CubeOutScalingTransformation;
import com.waytruck.cargo.slider.Transformations.DepthTransformation;
import com.waytruck.cargo.slider.Transformations.FadeTransformation;
import com.waytruck.cargo.slider.Transformations.FanTransformation;
import com.waytruck.cargo.slider.Transformations.FidgetSpinTransformation;
import com.waytruck.cargo.slider.Transformations.GateTransformation;
import com.waytruck.cargo.slider.Transformations.HingeTransformation;
import com.waytruck.cargo.slider.Transformations.HorizontalFlipTransformation;
import com.waytruck.cargo.slider.Transformations.PopTransformation;
import com.waytruck.cargo.slider.Transformations.SimpleTransformation;
import com.waytruck.cargo.slider.Transformations.SpinnerTransformation;
import com.waytruck.cargo.slider.Transformations.TossTransformation;
import com.waytruck.cargo.slider.Transformations.VerticalFlipTransformation;
import com.waytruck.cargo.slider.Transformations.VerticalShutTransformation;
import com.waytruck.cargo.slider.Transformations.ZoomOutTransformation;
