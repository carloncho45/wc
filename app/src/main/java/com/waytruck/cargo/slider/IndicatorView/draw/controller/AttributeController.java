package com.waytruck.cargo.slider.IndicatorView.draw.controller;
...
public class AttributeController {
    ...
    private void initAnimationAttribute(@NonNull TypedArray typedArray) {
        ...
        int animationDuration = typedArray.getInt(R.styleable.PageIndicatorView_piv_animationDuration,
